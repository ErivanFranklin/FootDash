  ...
  private updateDisplay(): void {
    ...
    if (this.isLive) {
      ...
      if (normalizedStatus.includes('HALFTIME') || normalizedStatus.includes('HALF')) {
        this.displayText = 'MATCH_STATUS.HT';
      } else if (normalizedStatus.includes('PAUSED')) {
        this.displayText = 'MATCH_STATUS.PAUSED';
      } else {
        this.displayText = 'MATCH_STATUS.LIVE';
      }
      ...
      this.displayText = 'MATCH_STATUS.FT';
      ...
      this.displayText = 'MATCH_STATUS.UPCOMING';
    } else if (normalizedStatus.includes('POSTPONED')) {
      this.badgeColor = 'warning';
      this.displayText = 'MATCH_STATUS.POSTPONED';
